...
def main(args):
    ...
    # Dataset
    # -----------------------------
    train_dataset = datasets.MNIST(root=args.data, train=True, download=True, transform=transform_train)
    test_dataset  = datasets.MNIST(root=args.data, train=False, download=True, transform=transform_test)
    ...
    # -----------------------------
    # Confusion Matrix
    # MNIST class names are simply the digit strings "0" through "9"
    # -----------------------------
...
if __name__ == "__main__":
    ...
    args = parser.parse_args()
>>>>>>> d1d928a5cdc9c85468153d0e0db3bd80e85c990b
    main(args) 